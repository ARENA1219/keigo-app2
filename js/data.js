...
const textbookQuestions = [
    ...
    { situation: "教科書の内容から：謙譲語の定義", textPre: "謙譲語は「", textPost: "」の動作をへりくだって相手を高める。", hint: "相手の動作？それとも自分の動作？", a: ["自分", "自身"], explanation: "謙譲語は「自分」の動作をへりくだる（低くする）ことで、相対的に相手を高める敬語です。" },
...
const wordQuestions = [
    ...
    { situation: "単語変換", textPre: "「来る」の謙譲語は「", textPost: "」。", hint: "", a: ["参る", "伺う"], explanation: "「来る」の謙譲語は「行く」と同じく「参る」「伺う」です。" },
    ...
    { situation: "単語変換", textPre: "「見る」の尊敬語は「", textPost: "」。", hint: "「ご（御）覧」を使った表現", a: ["ご覧になる", "御覧になる"], explanation: "「見る」の尊敬語は「ご覧になる（御覧になる）」です。「ご」は「御」の読み仮名で、どちらも正解です。" },
